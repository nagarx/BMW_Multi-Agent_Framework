...
class EpisodicMemory:
    ...
    def query_by_description(self, 
                           query: str, 
                           n_results: int = 5,
                           workflow_id: Optional[str] = None,
                           min_score: float = 0.6) -> List[Episode]:
        """
    ...
    def get_by_task_id(self, task_id: str) -> Optional[Episode]:
        ...
        """
        # Query description collection
        results = self.description_collection.get(
    ...
    def get_most_relevant(self, 
                        query: str, 
                        n_results: int = 3,
                        workflow_id: Optional[str] = None) -> List[Episode]:
        """
        ...
        desc_episodes = self.query_by_description(
            query, 
            n_results=n_results*2,  # Get more and filter later
