...
from bmw_agents.core.toolbox.tool import Tool, SimpleTool
...
class ToolboxRefiner:
    ...
    def __init__(self, base_toolbox: Toolbox):
        """
    ...
    def exclude_pattern(self, pattern: str) -> 'ToolboxRefiner':
        ...
        tools_to_remove = [
            tool.name for tool in self.refined_toolbox.get_all_tools()
    ...
    def add_simple_tool(self, 
                         name: str, 
                         func: Callable, 
                         description: Optional[str] = None) -> 'ToolboxRefiner':
        """
    ...
    def specialize_tool(self, 
                         original_name: str, 
                         new_name: str, 
                         description: Optional[str] = None,
                         fixed_params: Optional[Dict[str, Any]] = None,
                         required_params: Optional[List[str]] = None,
                         optional_params: Optional[List[str]] = None) -> 'ToolboxRefiner':
        """
        ...
        def specialized_function(*args, **kwargs):
            if fixed_params:
        ...
        for param_name, param_info in original_tool.parameters.items():
            ...
            if fixed_params and param_name in fixed_params:
                if not (required_params and param_name in required_params) and \
                   not (optional_params and param_name in optional_params):
                    continue
    ...
    def modify_tool_description(self, 
                               tool_name: str, 
                               new_description: str) -> 'ToolboxRefiner':
        """
    ...
    def modify_parameter_description(self, 
                                    tool_name: str, 
                                    param_name: str, 
                                    new_description: str) -> 'ToolboxRefiner':
        """
