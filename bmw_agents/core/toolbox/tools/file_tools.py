...
def csv_read(path: str, has_header: bool = True, delimiter: str = ",", encoding: str = "utf-8") -> List[Dict[str, str]]:
    """
    Read a CSV file.
...
def csv_write(path: str, data: List[Union[Dict[str, str], List[str]]], 
