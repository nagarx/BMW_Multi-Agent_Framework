...
async def main() -> None:
    ...
    # Check initial state
    print(
        f"Initial - Thoughts: {len(prompt_strategy.thoughts)}, Actions: {len(prompt_strategy.actions)}, Observations: {len(prompt_strategy.observations)}, Plans: {len(prompt_strategy.plans)}"
    )
    ...
    # Check final state
    print(
        f"After run - Thoughts: {len(prompt_strategy.thoughts)}, Actions: {len(prompt_strategy.actions)}, Observations: {len(prompt_strategy.observations)}, Plans: {len(prompt_strategy.plans)}"
    )
