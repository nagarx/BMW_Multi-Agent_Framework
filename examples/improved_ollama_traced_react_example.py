...
async def main():
    ...
    prompt_strategy = OllamaTracedReAct(
    ...
    # Check initial state
    print(f"Initial - Thoughts: {len(prompt_strategy.thoughts)}, Actions: {len(prompt_strategy.actions)}, Observations: {len(prompt_strategy.observations)}")
    ...
    # Check final state
    print(f"After run - Thoughts: {len(prompt_strategy.thoughts)}, Actions: {len(prompt_strategy.actions)}, Observations: {len(prompt_strategy.observations)}")
