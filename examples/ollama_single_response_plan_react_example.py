#!/usr/bin/env python3
"""
Example demonstrating the Ollama-specific SingleResponsePlanReAct strategy.
"""
...
from bmw_agents.core.prompt_strategies.ollama_single_response_plan_react import (
    OllamaSingleResponsePlanReAct,
)
...
async def main() -> None:
    """Run an example using the Ollama-specific SingleResponsePlanReAct strategy."""
    ...
    # Create the Ollama-specific SingleResponsePlanReAct prompt strategy
    prompt_strategy = OllamaSingleResponsePlanReAct(llm_provider=llm_provider, tools=tools)
