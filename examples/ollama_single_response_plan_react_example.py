...
from bmw_agents.core.prompt_strategies.ollama_single_response_plan_react import OllamaSingleResponsePlanReAct
...
async def main():
    ...
    prompt_strategy = OllamaSingleResponsePlanReAct(
