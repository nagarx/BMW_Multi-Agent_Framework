#!/usr/bin/env python3
"""
Example demonstrating the Ollama-specific SingleResponseReAct strategy.
"""
...
async def main() -> None:
    """Run an example using the Ollama-specific SingleResponseReAct strategy."""
    ...
    # Create the Ollama-specific SingleResponseReAct prompt strategy
    prompt_strategy = OllamaSingleResponseReAct(llm_provider=llm_provider, tools=tools)
